    ...
    <>
      ...
      className="min-h-screen  flex justify-between relative overflow-hidden aboutPage font-mono mt-10 px-24">
        ...
        <div className="w-full px-5 sm:w-3/5 flex  flex-col aboutTextPart">
          ...
          {/* Type Writer */}
          <div className="text-lg typeWriter sm:text-[20px]  lg:text-[33px] dark:text-white text-[#100f0f] flex gap-4">
            I'm a{" "}
          ...
          <div className="flex gap-4">
            <a href="/Ansar_CV.pdf" download>
            <Button 
            text={"Download Resume"} classes={`transparentButton`} />
            </a>
          </div>
        </div>
        {/* Image Part */}
